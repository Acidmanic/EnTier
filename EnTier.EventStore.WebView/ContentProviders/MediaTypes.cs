...
namespace EnTier.EventStore.WebView.ContentProviders
{
    ...
    {
        public static Dictionary<string, string> ContentTypeByFileExtension { get; }= new Dictionary<string, string>
        {
            { ".aac", "audio/aac" }, { ".abw", "application/x-abiword" }, { ".arc", "application/x-freearc" },
            { ".avif", "image/avif" }, { ".avi", "video/x-msvideo" }, { ".azw", "application/vnd.amazon.ebook" },
            { ".bin", "application/octet-stream" }, { ".bmp", "image/bmp" }, { ".bz", "application/x-bzip" },
            { ".bz2", "application/x-bzip2" }, { ".cda", "application/x-cdf" }, { ".csh", "application/x-csh" },
            ...
            { ".jpg", "image/jpeg" },{ ".jpeg", "image/jpeg" }, { ".js", "application/javascript" }, { ".json", "application/json" },
            { ".jsonld", "application/ld+json" }, { ".mid", "audio/midi, audio/x-midi" }, { ".midi", "audio/midi; audio/x-midi" },
            ...
            { ".ogx", "application/ogg" }, { ".opus", "audio/opus" }, { ".otf", "font/otf" }, { ".png", "image/png" },
            ...
            { ".svg", "image/svg+xml" }, { ".tar", "application/x-tar" }, { ".tif", "image/tiff" },{ ".tiff", "image/tiff" },
        ...
        public static string GetContentTypeForFile(string filePath)
        {
            ...
            if (ContentTypeByFileExtension.ContainsKey(extension))
            {
                var mime =  ContentTypeByFileExtension[extension];
