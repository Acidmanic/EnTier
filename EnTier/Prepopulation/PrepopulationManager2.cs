...
{
    public class PrepopulationManager2
    {
        private static PrepopulationManager2 _instance = null;
        private static readonly object Locker = new object();

        private PrepopulationManager2()
        {
        }

        public static PrepopulationManager2 GetInstance()
        {
            lock (Locker)
            {
                if (_instance == null)
                {
                    _instance = new PrepopulationManager2();
                }
            }
